...
- **Local** (esta pasta costuma ser gitignored). O que viaja pro time é só a **regra
  destilada** (campo 7) no `LEARNINGS.md` da raiz do repo, com link pra cá.
- Para INCIDENTES (debug com causa raiz) e decisões não-óbvias. Não pra trabalho trivial.
- Difere de `deep/` (investigações exploratórias soltas) por ter estrutura fixa de 7 campos.
