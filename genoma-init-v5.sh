#!/bin/bash
# ============================================================================
# genoma-init-v5.sh — Instalador Definitivo PGP GENOMA v5.0
# ============================================================================
#
...
print_header() {
  ...
  echo -e "${NC}"
  echo ""
  echo -e "     ${BOLD}PGP — Protocolo GENOMA Perpetuo v5.0${NC}"
...
print_ok ".context/ criado (kernel GENOMA v5)"
...
# v5: LEARNINGS.md vai pra RAIZ do projeto (versionado/compartilhado), nao em .context/
# (o indice terse de aprendizados viaja no git; os MDs de 7 campos ficam em .context/learnings/)
if [ -f "$CONTEXT_DIR/LEARNINGS.md" ] && [ ! -f "$PROJECT_PATH/LEARNINGS.md" ]; then
  mv "$CONTEXT_DIR/LEARNINGS.md" "$PROJECT_PATH/LEARNINGS.md"
  print_ok "LEARNINGS.md criado na raiz (indice de aprendizados, versionado)"
fi
...
if [ -d "$PROJECT_PATH/.git" ]; then
  ...
  if ask_yn "Criar commit inicial do GENOMA v4?" "s"; then
    ...
    git commit -m "context(genoma): initialize PGP GENOMA v5.0 ($INSTALL_MODE) for $PROJECT_NAME
...
echo -e "${CYAN}   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo -e "${BOLD}${GREEN}     GENOMA v5.0 — INSTALADOR DEFINITIVO ATIVO!${NC}"
echo ""
